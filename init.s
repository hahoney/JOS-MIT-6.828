...
.LFBB3:
	...
	pushl	%ebx
	movl	16(%ebp), %ebx
	.stabn	68,0,62,.LM14-.LFBB3
.LM14:
	cmpl	$0, panicstr
	je	.L11
	.align 4
.L10:
	.stabn	68,0,78,.LM15-.LFBB3
.LM15:
	subl	$12, %esp
	pushl	$0
	call	monitor
...
.LM20:
	...
	pushl	%ebx
	call	vcprintf
	.stabn	68,0,72,.LM21-.LFBB3
.LM21:
	movl	$.LC4, (%esp)
	call	cprintf
	.stabn	68,0,73,.LM22-.LFBB3
.LM22:
	addl	$16, %esp
	jmp	.L10
	.size	_panic, .-_panic
